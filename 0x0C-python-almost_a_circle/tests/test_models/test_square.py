#!/usr/bin/python3
"""Unittests module for square base"""
import io
import sys
import unittest
...
class TestSquare_instantiation(unittest.TestCase):
    """Class unittest for instantiation testing foe square class"""
...
class TestSquare_size(unittest.TestCase):
    """Class unittest for size testing of a square"""
...
class TestSquare_x(unittest.TestCase):
    """Class unittest x attribute initialization"""
    def test_str_x(self):
...
class TestSquare_y(unittest.TestCase):
    """Class testing for y attribute initialization"""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """Class unittest testing order of a square attribute"""
...
class TestSquare_area(unittest.TestCase):
    """Class unittest testing area of a square """
...
class TestSquare_stdout(unittest.TestCase):
    """Class unittests for testing __str__ and display methods of Square"""
    @staticmethod
...
class TestSquare_update_args(unittest.TestCase):
    """Class Unittests for testing update args method of the Square"""
...
class TestSquare_update_kwargs(unittest.TestCase):
    """Class unittest for testing update kwargs method of Square"""
